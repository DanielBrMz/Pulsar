import { AvailableService, CarAround, CarTypeDataItem, FilterDataItem, PaymentOption, RequestDataItem, RideDataItem, RideOption } from "../types/global-types";

export const filterData: FilterDataItem[] = [ {name:"Ride",image: require('../../assets/ride.png'), id:"0"},
...
export const rideData: RideDataItem[] =[
...
export const carTypeData: CarTypeDataItem[] =[
    {title:"Popular",
     data:[
 ...
 export const requestData: RequestDataItem[] = [{
    name:"For Me",id:0
},
{
...
export const rideOptions: RideOption[] = [{name:"Personal",icon:"account", id:"0"},
{name:"Business",icon:"briefcase", id:"1"},  

];

export const paymentOptions: PaymentOption[] = [{image:require('../../assets/visaIcon.png'),text:"Visa ...0476"},
                                {image:require('../../assets/cashIcon.png'),text:"Cash"}]

export const availableServices: AvailableService[] = ["Uber Go","UberX","Uber connect","Uber Black","Uber Van","Uber Assist"]

export const carsAround: CarAround[] = [{latitude:-26.207487,longitude:28.236226},
